...
$workExperience = [
    ...
    [
        ...
        'periodFinish' => '   ',
        'description' => '- Провожу функциональное, исследовательское, смоук тестирование;
        - Создала библиотеку, разработав тест-кейсы и чек-листы по проекту, составляю тест-планы (TestIT).'
      ],
  [
    'jobTitle' => 'Специалист по тестированию ПО',
    'periodStart' => 'Jul 2021',
    'periodFinish' => 'Aug 2022',
    'description' => 'Провожу функциональное тестирование ПО, web-приложений, API (Postman/Insomnia/Swagger);
    Покрыла с ноля тест-кейсами основной функционал системы;
    Составила чек-листы;
    Обнаруживала и описывала дефекты ПО (YouTrack);'
  ]
];
?>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>АФ ННГУ (аспирантура)</b></h5>
